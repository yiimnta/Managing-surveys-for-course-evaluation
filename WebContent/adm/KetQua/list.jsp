	...
	<div class="col-md-12">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<h5>Danh sách Kết quả đánh giá</h5>
			</div>
			<div class="ibox-content p-sm" id="productList">
				<logic:empty name="dsKetQuaForm" property="dsKetQua" >
					<h3 style="text-align:center;">Hiện tại chưa có Kết quả đánh giá nào cả</h3>
				</logic:empty>
				<logic:notEmpty name="dsKetQuaForm" property="dsKetQua" >
					<table id="pageIndex" class="table table-striped table-hover">
						...
						<tbody id="tbodyTable">
							<logic:iterate name="dsKetQuaForm" property="dsKetQua"
								id="ac">
								<bean:define id="maKQ" 			name="ac" property="maKQ" />
								...
								<bean:define id="phieuDanhGia"  name="ac" property="phieuDanhGia" />
								...
								<tr>
									<td>${maKQ}</td>
									<td><b>Tiêu đề:</b> ${tieuDe}<br/>
										<b>Thời gian đăng:</b> ${thoiGianDang}<br/>
										<b>Loai Phiếu:</b> ${loaiP}
									</td>
									<td>
										<b>Họ tên:</b> ${hoTen}<br/>
										<b>Email:</b> ${email}<br/>
									...
									<td>${thoiGian}</td>
									<td>
										<a href="#" class="delete-kq" data-url="xoaKetQua.do?maKQ=${maKQ}"
											style="margin-left: 30px;"> 
											<span class="glyphicon glyphicon-trash"></span>
										</a>
										<a href="chiTietKetQua.do?maKQ=${maKQ}" style="margin-left: 30px;"> 
